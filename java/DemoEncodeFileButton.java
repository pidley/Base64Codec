...
class DemoEncodeFileButton extends JButton implements ActionListener {
   ...
   int            result        =   0 ;
      ...
      try {
         ...
         if ( !DemoResources.isNull(file) ) {
            setFile(file) ;
            textField   =   (JTextField)DemoResources.findComponent(((JButton)e.getSource()).getParent(), "EncodeTextField") ;
